...
import { kdfsPreset } from '../src/preset.js';
...
test('Scrypt validates params', () => {
  assert.throws(() => deriveScrypt(undefined as unknown as Parameters<typeof deriveScrypt>[0]), /Scrypt requires params/);
...
test('Argon2 validates params', () => {
  assert.throws(() => deriveArgon2(undefined as unknown as Parameters<typeof deriveArgon2>[0]), /Argon2 requires params/);
