import { assertBlockSize, assertPaddedInput, getBlockPaddingLength, type PaddingComponent, type PresetComponent } from '@jscrypto/core';
...
export const pkcs7Preset: PresetComponent<'pkcs7'> = {
  kind: 'preset',
  name: 'pkcs7',
  components() {
    return [pkcs7];
